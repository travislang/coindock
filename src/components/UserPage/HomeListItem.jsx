                    ...
                    primary={
                        <div className={classes.primaryText}>
                            ...
                            <React.Fragment>
                                ...
                                <Typography component="span" variant='body1' className={coin.price_change > 0 ? classes.textPercentPos : classes.textPercentNeg}>{Number(coin.price_change).toFixed(2)}%</Typography>
                            </React.Fragment>
