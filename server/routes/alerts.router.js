...
// delete all alerts owned by user
...
// delete single alert owned by user
...
router.put('/remove-chip/:id', rejectUnauthenticated, (req, res) => {
...
router.put('/toggle-alert/:id', rejectUnauthenticated, (req, res) => {
...
router.put('/update-order', rejectUnauthenticated, (req, res) => {
